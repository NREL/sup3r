...
def test_train_st_mom1(log=False, full_shape=(20, 20),
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        assert 'test_1' in os.listdir(out_dir_root)
        assert 'model_gen.pkl' in os.listdir(out_dir_root + '/test_1')
...
def test_train_st_mom1_sf(log=False, full_shape=(20, 20),
                          sample_shape=(12, 12, 24), n_epoch=4,
                          batch_size=4, n_batches=4,
                          out_dir_root=None):
...
def test_train_st_mom2(log=False, full_shape=(20, 20),
                       sample_shape=(12, 12, 24), n_epoch=4,
                       batch_size=4, n_batches=4,
                       out_dir_root=None,
                       model_mom1_dir=None):
...
def test_train_st_mom2_sf(log=False, full_shape=(20, 20),
                          sample_shape=(12, 12, 24), n_epoch=4,
                          batch_size=4, n_batches=4,
                          out_dir_root=None,
                          model_mom1_dir=None):
