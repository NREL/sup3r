...
def test_correct_access_wrapper():
    ...
    assert isinstance(out, DatasetWrapper)
...
def test_correct_access_single_member_data():
    ...
    data = Data(make_fake_dset((20, 20, 100, 3), features=['u', 'v']))
...
def test_correct_access_multi_member_data():
    ...
    assert all(isinstance(o, DatasetWrapper) for o in out)
