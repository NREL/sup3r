...
if __name__ == "__main__":
    ...
    # test_train_spatial_mom1(n_epoch=10, log=True, full_shape=(20, 20),
    #                    sample_shape=(10, 10, 1),
    ...
    test_train_spatial_mom2(n_epoch=10, log=True, full_shape=(20, 20),
                            sample_shape=(10, 10, 1),
                            batch_size=16, n_batches=100,
                            out_dir_root='s_model',
                            model_dir='s_model_save/spatial_cond_mom')
