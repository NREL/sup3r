...
def test_train_st_weight_update(n_epoch=4, log=False):
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        model.train(batch_handler, n_epoch=n_epoch,
                    weight_gen_advers_s=1e-2, weight_gen_advers_t=1e-2,
...
def test_train_st_kld(n_epoch=4, log=False):
    ...
    SpatioTemporalGanKLD.seed()
    model = SpatioTemporalGanKLD(fp_gen, fp_disc_s, fp_disc_t,
                                 learning_rate=1e-4,
                                 learning_rate_s=2e-4,
                                 learning_rate_t=3e-4)
...
def test_train_st_mmd(n_epoch=4, log=False):
    ...
    SpatioTemporalGanMMD.seed()
    model = SpatioTemporalGanMMD(fp_gen, fp_disc_s, fp_disc_t,
                                 learning_rate=1e-4,
                                 learning_rate_s=2e-4,
                                 learning_rate_t=3e-4)
