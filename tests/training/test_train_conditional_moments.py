...
from sup3r.preprocessing.conditional_moment_batch_handling import (
    ...
    BatchHandlerMom1SFPrecomp,
    BatchHandlerMom2SFPrecomp,
    BatchHandlerMom2SepSFPrecomp)
...
@pytest.mark.parametrize('FEATURES, t_enhance_mode',
                         [(['U_100m', 'V_100m'], 'constant'),
                          (['U_100m', 'V_100m'], 'linear')])
def test_train_st_mom1_sf_precomp(FEATURES,
                                  t_enhance_mode,
                                  end_t_padding=False,
                                  log=False, full_shape=(20, 20),
                                  sample_shape=(12, 12, 24), n_epoch=2,
    ...
    elr_handler = ELRDataHandlerH5(
        FP_WTK, FEATURES, target=TARGET_COORD,
        shape=full_shape,
        sample_shape=sample_shape,
        temporal_slice=temporal_slice,
        val_split=0.005,
    ...
    batch_handler = BatchHandlerMom1SFPrecomp(
        [handler], [elr_handler], batch_size=batch_size,
        s_enhance=2, t_enhance=4,
        n_batches=n_batches,
        end_t_padding=end_t_padding,
        temporal_enhancing_method=t_enhance_mode)
...
@pytest.mark.parametrize('FEATURES',
                         (['U_100m', 'V_100m'],))
def test_train_st_mom2_sf_precomp(FEATURES,
                                  t_enhance_mode='constant',
                                  end_t_padding=False,
                                  log=False, full_shape=(20, 20),
                                  sample_shape=(12, 12, 16), n_epoch=2,
    ...
    batch_handler = BatchHandlerMom2SFPrecomp(
        [handler], [elr_handler], batch_size=batch_size,
        s_enhance=2, t_enhance=4,
        n_batches=n_batches,
        model_mom1=model_mom1,
...
@pytest.mark.parametrize('FEATURES',
                         (['U_100m', 'V_100m'],))
def test_train_st_mom2_sep_sf_precomp(FEATURES,
                                      t_enhance_mode='constant',
                                      end_t_padding=False,
                                      log=False, full_shape=(20, 20),
                                      sample_shape=(12, 12, 16), n_epoch=2,
    ...
    batch_handler = BatchHandlerMom2SepSFPrecomp(
        [handler],
        [elr_handler],
        batch_size=batch_size,
        s_enhance=2, t_enhance=4,
