...
class SpatioTemporalGan(BaseModel):
    ...
    def update_adversarial_weights(self, loss_details,
        ...
        n_update_epochs : int
            ...
            over before checking for update conditions. e.g. If n_update_epochs
    ...
    def train(self, batch_handler, n_epoch,
              ...
              adaptive_update_fraction=0.05, n_update_epochs=5):
        ...
        for epoch in epochs:
            ...
            out = self.update_adversarial_weights(
                ...
                train_disc_t, n_update_epochs=n_update_epochs)
