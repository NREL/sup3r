...
class Sup3rGanFixedObs(Sup3rGan):
    ...
    def _get_hr_exo_and_loss(
        ...
        **calc_loss_kwargs,
        ...
        loss, loss_details, loss_weights, hi_res_gen, hi_res_exo = out
        ...
        loss_details['loss_non_obs'] = loss_non_obs

        if self.loss_obs_weight is not None and calc_loss_kwargs['train_gen']:
            loss_weights['loss_obs'] = self.loss_obs_weight
            loss_obs_w = loss_obs * self.loss_obs_weight
            loss += loss_obs_w
            loss_details['loss_gen'] = loss
            loss_details['loss_gen_content'] += loss_obs_w
