...
class BatchHandlerCC(BatchHandler):
    ...
    def __next__(self):
        ...
        -------
        batch : Batch
            Batch object with batch.low_res and batch.high_res
            and batch.output attributes with the appropriate coarsening.
        """
        self.current_batch_indices = []
        ...
        mask = self.BATCH_CLASS.make_mask(high_res,
                                          self.s_padding, self.t_padding)
        batch = self.BATCH_CLASS(low_res, high_res, output, mask)
