...
class BatchHandlerCC(BaseHandlerCC):
    ...
    def __init__(
        ...
        **kwargs : dict
        ...
        msg = (
            ...
            f'!= 24 or 1. Received t_enhance = {t_enhance}.'
        )
        assert t_enhance in (24, 1), msg
    ...
    def batch_next(self, samples):
        """Down samples high res (hourly) and smoothes lr / hr if requested.
        Normalizes lr / hr and returns wrapped collection of samples /
        observations.
        """
    ...
    def transform(
        ...
        """"For this special CC handler the transform consists of: subsample
        hourly data to the daylight window if t_enhance != 1 and smooth if
        requested.
