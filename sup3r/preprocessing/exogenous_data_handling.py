...
class ExogenousDataHandler:
    ...
    def __init__(self, file_paths, features, source_h5, s_enhancements,
        ...
        s_enhancements : list
            ...
            For example, if file_paths has 100km data and there are 2x spatial
            ...
            exogenous data at 25km (s_enhance=4, exo_step=1). The length of
            this list should be equal to the number of agg_factors and the
            number of exo_steps
        agg_factors : list
